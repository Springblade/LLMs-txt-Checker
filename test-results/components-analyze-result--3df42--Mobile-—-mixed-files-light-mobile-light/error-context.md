...
- Name: components\analyze-result-details.spec.ts >> AnalyzeResultDetails >> Mobile — mixed files, light
- Location: e2e\components\analyze-result-details.spec.ts:217:7
