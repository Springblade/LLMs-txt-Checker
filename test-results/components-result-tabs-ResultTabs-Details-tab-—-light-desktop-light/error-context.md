...
- Name: components\result-tabs.spec.ts >> ResultTabs >> Details tab — light
- Location: e2e\components\result-tabs.spec.ts:35:7
...
Call log:
  - waiting for locator('[class*="result-tabs"], .card-interactive, [class*="result"]').first()
