...
- Name: components\results-error-panel.spec.ts >> Open expected file link — light
- Location: e2e\components\results-error-panel.spec.ts:110:5
...
Call log:
  - waiting for getByRole('link', { name: /open expected file/i })
