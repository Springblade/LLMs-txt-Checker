...
- Name: components\validator-form.spec.ts >> ValidatorForm >> Validate Text tab — loading, light
- Location: e2e\components\validator-form.spec.ts:166:7
...
Call log:
  - waiting for locator('form').filter({ hasText: /validating/i })
  ...
  - generic [ref=e12]:
    ...
    - main [ref=e36]:
      ...
      - generic [ref=e49]:
        - img [ref=e51]
        - generic [ref=e53]:
          - heading "Connection failed" [level=2] [ref=e54]
          - paragraph [ref=e55]: Connection error. Please try again.
