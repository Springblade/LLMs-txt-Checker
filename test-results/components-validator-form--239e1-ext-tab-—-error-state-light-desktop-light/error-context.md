...
- Name: components\validator-form.spec.ts >> ValidatorForm >> Validate Text tab — error state, light
- Location: e2e\components\validator-form.spec.ts:194:7
  ...
  - generic [ref=e12]:
    ...
    - main [ref=e36]:
      ...
      - generic [ref=e49]:
        - img [ref=e51]
        - generic [ref=e53]:
          - heading "HTTP error" [level=2] [ref=e54]
          - paragraph [ref=e55]: HTTP error 400
